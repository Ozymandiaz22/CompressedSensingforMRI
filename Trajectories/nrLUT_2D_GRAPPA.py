...
output_folder = Path("./output/nrLUT_2D_GRAPPA_trajectories")  # Output folder
...
for R in acceleration_factors:
    ...
    plt.imsave(output_folder / f'nrLUT_2D_GRAPPA_R{AF:.2f}_pct{100*NE/(size_of_kspace[0]*size_of_kspace[1]):.1f}.bmp',
